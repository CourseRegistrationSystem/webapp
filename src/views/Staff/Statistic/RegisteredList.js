...
class RegisteredList extends Component {
  ...
  onPaginationNav = (type) => {
    ...
    if (type === "first") {
      ...
      dispatch({
        type: CONSTANTS.STUDENT.STUDENT_PAGE_CHANGE,
      ...
      <div>
        <Card>
          <CardBody>
            ...
            <InputGroup>
              <Input
                ...
                style={{
                  ...
                  borderColor: "drop-shadow(0px 4px 4px rgba(0, 0, 0, 0.25))",
                }}
              />
            ...
            <div className="text-muted small">* Name, Matric Number</div>
            ...
            <Card>
              <Table className="table table-hover mb-0 d-none d-sm-table" hover>
                  ...
                  >
                    ...
                    >
                      ...
                      <DropdownMenu>
                        ...
                        <DropdownItem
                          onClick={() => {
                            this.onPaginationCountChange(3);
                          }}
                        >
                          3
                        </DropdownItem>
                        ...
                        <DropdownItem
                          onClick={() => {
                            this.onPaginationCountChange(100);
                          }}
                        >
                          100
                        </DropdownItem>
